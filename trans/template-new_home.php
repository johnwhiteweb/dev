...
<div class="home-page case-study newHome ">
	...
	?>
		...
		if ($value['type'] == 'Top Banner') {
			...
			$float = "style='position: absolute;top: 350px;z-index: 4;left: 250px;'";
		?>
			<?php if ($value['top_banner']['top_banner'] !== '') {


			?>
				<section class="solution-bg img_section" style="display:block;">


					<?php if ($value['top_banner']['video_type'] == 'Youtube Video') {
						$data_type = "youtube";
						$yout_url = $value['top_banner']['youtube_video'];
						preg_match('%(?:youtube(?:-nocookie)?\.com/(?:[^/]+/.+/|(?:v|e(?:mbed)?)/|.*[?&]v=)|youtu\.be/)([^"&?/ ]{11})%i', $yout_url, $match);
						$video_id = $match[1];
					?>

						<div id="bgvideo" data-id="<?php echo $video_id; ?>" data-autoplay='true'>

							<iframe width="100%" height="650" src="https://www.youtube.com/embed/<?php echo $video_id; ?>?autoplay=1&controls=0&&showinfo=0&loop=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen allow="autoplay" encrypted-media"></iframe>
					...
					<?php if ($value['top_banner']['video_type'] == "Local Video") { ?>
						<div id="poster-image"></div>
						<div id="bgvideo">
							<video autoplay="" muted="" loop="" playsinline="" poster="<?php echo $value['top_banner']['image']; ?>" id="tact-myVideo" width="100%">
								<source src="<?php echo $value['top_banner']['local_video']; ?>" type="video/mp4">
							</video>
						</div>
					<?php
					} ?>
					...
					<div class="container align-middle" id="mobile-vid" <?php echo $float; ?>>
	...
	#poster-image {
                  background: url('<?php echo $value['top_banner']['image']; ?>') center center;
		...
		if ($value['type'] == 'About us (video)') {
			...
			<section class="solution-bg" id="about-us">
				...
				<div class="top-white text-center">
					...
					<div class="item clearfix vid-cont">
						...
						?>
							...
							<a class="btn vpop lo" href="#" data-type="<?php echo $data_type; ?>" data-id="<?php echo $video_id; ?>" data-autoplay='true'>
								<div class="float-center-text btn " id="vidTitle">
					...
					<div class="container">
						...
						<ul class="row matchHeight">
							...
							foreach ($value['our_solution']['items'] as $item) {
								$content = $item['text'];
								// $content = substr($content, 0, strpos($content, ' ', 35));
								...
								<li id="box-<?php echo $i; ?>" class="box<?php echo ($i == 1 ? "" : ""); ?> col">
									<a class="btn" href="<?php echo $item['read_more_link']; ?>">
										...
										<div class="text-box match text-center">
											...
											<p class="font-weight-bold-item"><?php echo $content; ?>...</p>
	...
	icon icon_hover title text -->
		...
		?>
			<section class="client-section testimonials">
				<div class="container">
								...
								<div class="row">
									<div class="col-md-4">
										...
										<?php if ($select_video_type == 'Local') { ?>
											...
											<a id="test-vid" class="" href="#" data-toggle="modal" data-target="#localVideoLocal-<?= $x; ?>">
										...
										<?php if ($select_video_type == 'YouTube') { ?>
											...
											<a id="test-vid" class="" href="#" data-type="youtube" data-id="<?php echo $video_id; ?>" data-autoplay='true' data-toggle="modal" data-target="#youtubeVideo-<?= $x; ?>">
												<div class="play_tri"></div>
												<img class="img-fluid" src="<?php echo $image; ?>" />
											</a>
										<?php } ?>
...
<?php	
	...
	<section class="container awards-section">
		...
		<h2 class="center-text mx-auto text-center"><?php echo $value['awards']['heading']; ?></h2>
			...
			<div class="awards-slider desktop">
				<?php 
		...
		<div class="awards-slider mobile">
...
<div class="item2">
				<div class="img-box2">
				<img class="img-fluid mx-auto d-block2" src="<?php echo $item['image']; ?>" width="200">
...
<script>
	jQuery(document).ready(function($) {
		...
		// 	let id = $("#bgvideo").data('id');
		// 	let autoplay = '?enablejsapi=1&autoplay=1&rel=0?';

		// 	$("#bgvideo iframe").attr('src', srchref + id + autoplay);
		// 	console.log($("#bgvideo iframe"));
		// });
