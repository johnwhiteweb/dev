							...
							<div class="box b-box" style="/*background-image:url(<?php echo $image; ?>)*/">
								<a href="<?php echo get_the_permalink($item->ID); ?>">
									...
									<div class="text-box">
										...
										<p>
										<h2 class="field field-name-field-penton-content-summary field-type-text-long field-label-hidden"><?php echo $item->post_excerpt; ?></h2>
										</p>
						...
						<?php if ($i <= 3 || ($pages - 3 < $i)) { ?>
							...
							<?php if ($pages == $i) { ?>
								...
								<li class="page-item<?php echo ($m == $page ? " active" : ""); ?>">
									<a class="page-link" href="?cat_tab=all_cat&all_pag=<?php echo $next_page; ?>"><i class="fa fa-angle-right"></i></a>
								</li>
