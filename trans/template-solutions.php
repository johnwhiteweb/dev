						...
						?>
							<div class="item clearfix">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<a class="img-box float-left <?php if (!empty($youtube_id)) { ?> add_play V_pop<?php echo $x;
																													} ?>" onclick="return false" href="#" data-type="youtube" data-id="<?php echo $youtube_id; ?>" data-autoplay='true'>
