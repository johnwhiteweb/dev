...
register_post_type( 'case-studies',
		array(
			'labels' => array(
				"name"			     =>	__('Case Studies', 'tyto'),
				"singular_name"	     =>	__('Case Study', 'tyto'),
				"add_new"			 =>	__('Add Case Study', 'tyto'),
				"add_new_item"	     =>	__('Add New Case Study', 'tyto'),
				"edit_item"		     =>	__('Edit Case Study', 'tyto'),
				"new_item"		     =>	__('New Case Study', 'tyto'),
				"view_item"		     =>	__('Show Case Studies', 'tyto'),
				"search_items"	     =>	__('Search Case Studies', 'tyto'),
				"not_found"		     =>	__('No Case Studies Found', 'tyto'),
				"not_found_in_trash" =>	__('No Case Studies Found in the Trash', 'tyto'),
				"parent_item_colon"  =>	__('Parent Case Studies', 'tyto'),
				"edit"			     =>	__('Edit Case Study', 'tyto'),
				"view"			     =>	__('Show Case Studies', 'tyto')
			),
			...
			'rewrite'         => array( 'slug' => 'case-studie', 'with_front' => false)
		)
	);
