...
?>
	<section class="container trusted-section ">
		<div class="container mobile-block row">
			...
			<div class="trusted-slider desktop col-lg-10">
				<?php
	...
	<section class="solution-bg">
		...
		<div class="top-white text-center">
			...
			<div class="item clearfix">
				...
				<?php if ($value['about_us']['video_type'] == "Local Video") { ?>
					<a class="" data-autoplay='true' onclick="switchVid()">
						<span id="butPlay" class="img-box float-left video_play"></span>

						<div class="float-center-text" id="vidTitle">
							<?php echo $value['about_us']['video_center_title'] ?>
						</div>

						<div class=" container col-10">

							<video autoplay="false" muted="" loop="false" playsinline="" id="localVideo" poster="<?php echo $value['about_us']['video_image_poster']; ?>">
