...
<footer class="footer">
	...
	<div class="container row mx-auto">
		<div class="logo-part col-3">
			<a class="navbar-brand" href="<?php echo get_home_url(); ?>"><img class="images-fluid" src="<?php the_field('footer_logo', 'option'); ?>"></a>
		...
		<div class="col-1"></div>
		<ul class="col-4 ">
			<div class="newsletter"><div class="contact open">
				<p>
		...
		<div class="container row mx-auto social-footer">
			...
			<div class="col">
				...
				<a href="http://www.linkedin.com/company/tactile-mobility/" class="in">
					...
					<img src="<?php echo get_site_url(); ?>/wp-content/uploads/2021/07/in-2.png" data-val="<?php echo get_site_url() ?>/tactilemobility/wp-content/uploads/2021/07/in.png" />
				</a>
			</div>
		</div>
...
<script>
	...
	jQuery(document).ready(function($) {
		...
		// $("li.linkedin0").on("mouseenter", function() {
		// 	//alert('hello');
		// 	var sttr = $(this).find("img").attr("src");
		// 	$(this).find("img").attr("data-val", sttr);
		// 	// $(this).find("img").attr("src", "<?php echo get_theme_file_uri('images/linkedin-with-bg.svg') ?>");
