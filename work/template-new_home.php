...
<div class="home-page case-study newHome ">
	...
	?>
		...
		if ($value['type'] == 'Top Banner') {
			...
			$float = "style='position: absolute;top: 350px;z-index: 2;left: 250px;'";
		?>
			...
			?>
				<section class="solution-bg img_section" style="display:block;">
					...
					<?php if ($value['top_banner']['video_type'] == "Local Video") { ?>
						<div id="bgvideo">
							<video autoplay="" muted="" loop="" playsinline="" id="tact-myVideo" width="100%">
			...
			<div class="client-slider desktop">
				...
				foreach ($testimonials as $item) {
					...
					if ($select_video_type == 'Local') {
						...
						$video_id = $match[1];
						$videoUrl = ltrim($video_id, 'g');
					} elseif ($select_video_type == 'Other / external') {
						$videoUrl = $other;
					}
				?>
					...
					<div class="item clearfix">
						<div class="row">
							<div class="col-md-4">
								...
								<a class="" href="#" data-toggle="modal" data-target="#playVideoPopUp" data-url="<?= $videoUrl ?>" data-type="<?= $select_video_type ?>">
...
<script>
	jQuery(document).ready(function($) {
		...
		$('.box').mouseenter(function() {
			console.log($(this > '.read-more img'));
			$(this > '.read-more img').css('left', ' 6px');
			// $(this).find('text-box .read-more img').css('left', ' 6px');
